  ...
  async getCars(params = {}) {
    ...
    if (params.search) {
      ...
      list = list.filter(c => 
        ...
        c.body_type.toLowerCase().includes(s) ||
        c.fuel_types.some(f => f.toLowerCase().includes(s)) ||
    ...
    if (params.body_type) {
      list = list.filter(c => c.body_type.toLowerCase() === params.body_type.toLowerCase());
    }
    if (params.fuel) {
      list = list.filter(c => c.fuel_types.some(f => f.toLowerCase() === params.fuel.toLowerCase()));
    }
